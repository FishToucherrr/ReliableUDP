...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, SackRandomDropTest, RandomRepeatTest,RandomOrderTest
    file_name="b.png"
    BasicTest.BasicTest(forwarder, file_name)
    
    RandomRepeatTest.RandomRepeatTest(forwarder, file_name)
    RandomOrderTest.RandomOrderTest(forwarder, file_name)
